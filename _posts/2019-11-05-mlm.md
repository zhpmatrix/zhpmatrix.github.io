...
![a](https://wx3.sinaimg.cn/mw690/aba7d18bly1gaevt36bxsj20h704pjsq.jpg)

训练时，生成器和判别器同时训练；测试时只要判别器。那么，在该范式下，数据的构造如下：

![data](https://wx4.sinaimg.cn/mw690/aba7d18bly1gaevt70idzj20hy05hadi.jpg)

最后，模型的性能表现如下，红框表示最优和最差结果的对比。

![performance](https://wx2.sinaimg.cn/mw690/aba7d18bly1gaevtan4buj20gw09rjuf.jpg)
